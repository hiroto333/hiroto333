...
**概要**<br>
学生IT団体のハッカソンで開発した参考文献変換アプリ「りふぁまる」です．卒論執筆時に参考文献作成の手間を感じたことがきっかけで制作しました．研究報告・論文・書籍・URL を入力または読み込むだけで，研究室指定の参考文献形式に自動で変換できます．変換した文献は保存・管理でき，後からまとめてコピーすることも可能です．現在は，入力不要でURLやPDFから直接変換できる機能を継続的に開発しています．
